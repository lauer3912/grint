...
@class GrintBReviewStats;

@interface GrintBDetail7 : UIViewController <SKPSMTPMessageDelegate> {
...
@property (strong, nonatomic) GrintBReviewStats *detailViewController;
