...
- (IBAction)backToStart:(id)sender{
   ...
   NSLog(@"Start Sending");
    ...
    for(int i = 1; i <= 18; i++){
        ...
        [parameters appendFormat:@"&scH%d=%@", i, ((GrintScore*)[self.scores objectAtIndex:i-1]).score];
        
    }
    for(int i = 1; i <= 18; i++){
        
        [parameters appendFormat:@"&pH%d=%@", i, ((GrintScore*)[self.scores objectAtIndex:i-1]).penalty];
        
    }
    for(int i = 1; i <= 18; i++){
        
        [parameters appendFormat:@"&ptH%d=%@", i, ((GrintScore*)[self.scores objectAtIndex:i-1]).putts];
        
    }
    for(int i = 1; i <= 18; i++){
        
        NSString* strFH = [[[[[[((GrintScore*)[self.scores objectAtIndex:i-1]).fairway stringByReplacingOccurrencesOfString:@"Shank" withString:@"5" ]  stringByReplacingOccurrencesOfString:@"Lo" withString:@"6" ]stringByReplacingOccurrencesOfString:@"H" withString:@"3"] stringByReplacingOccurrencesOfString:@"R" withString:@"2"]stringByReplacingOccurrencesOfString:@"L" withString:@"1"] stringByReplacingOccurrencesOfString:@"S" withString:@"4" ];
        [parameters appendFormat:@"&fH%d=%@", i, strFH];
    ...
    if (connection ) {
        ...
        for(GrintScore* s in self.scores){
            [s removeNulls];
        }
        ...
        for(int i = 1; i <= 18; i++){
            ...
            [_params setObject:[((GrintScore*)[self.scores objectAtIndex:i-1]).score stringByReplacingOccurrencesOfString:@"(null)" withString:@""] forKey:[NSString stringWithFormat:@"scH%d", i]];
                        
        }
        for(int i = 1; i <= 18; i++){
            
            [_params setObject:[((GrintScore*)[self.scores objectAtIndex:i-1]).penalty stringByReplacingOccurrencesOfString:@"(null)" withString:@""]  forKey:[NSString stringWithFormat:@"pH%d", i]];

            
        }
        for(int i = 1; i <= 18; i++){
            
            [_params setObject:[((GrintScore*)[self.scores objectAtIndex:i-1]).putts stringByReplacingOccurrencesOfString:@"(null)" withString:@""]  forKey:[NSString stringWithFormat:@"ptH%d", i]];
            
        }
        
        NSString* strFH;
        for(int i = 1; i <= 18; i++){
            strFH = [[[[[[[((GrintScore*)[self.scores objectAtIndex:i-1]).fairway stringByReplacingOccurrencesOfString:@"Shank" withString:@"5" ]  stringByReplacingOccurrencesOfString:@"Lo" withString:@"6" ]stringByReplacingOccurrencesOfString:@"H" withString:@"3"] stringByReplacingOccurrencesOfString:@"R" withString:@"2"]stringByReplacingOccurrencesOfString:@"L" withString:@"1"] stringByReplacingOccurrencesOfString:@"S" withString:@"4" ] stringByReplacingOccurrencesOfString:@"(null)" withString:@""];
            [_params setObject: strFH  forKey:[NSString stringWithFormat:@"fH%d", i]];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    if (connection ) {
        ...
        if (!self.detailViewController) {
            self.detailViewController = [[GrintBReviewStats alloc] initWithNibName:@"GrintBReviewStats" bundle:nil];
        }
        
        ((GrintBReviewStats*)self.detailViewController).username = self.username;
        ((GrintBReviewStats*)self.detailViewController).courseName= self.courseName;
        ((GrintBReviewStats*)self.detailViewController).courseAddress= self.courseAddress;
        ((GrintBReviewStats*)self.detailViewController).teeboxColor= self.teeboxColor;
        ((GrintBReviewStats*)self.detailViewController).date = self.date;
        ((GrintBReviewStats*)self.detailViewController).score = self.score;
        ((GrintBReviewStats*)self.detailViewController).putts = self.putts;
        ((GrintBReviewStats*)self.detailViewController).penalties = self.penalties;
        ((GrintBReviewStats*)self.detailViewController).accuracy = self.accuracy;
        ((GrintBReviewStats*)self.detailViewController).player1 = self.player1;
        ((GrintBReviewStats*)self.detailViewController).player2 = self.player2;
        ((GrintBReviewStats*)self.detailViewController).player3 = self.player3;
        ((GrintBReviewStats*)self.detailViewController).player4 = self.player4;
        ((GrintBReviewStats*)self.detailViewController).courseID = self.courseID;
        ((GrintBReviewStats*)self.detailViewController).attachedScorecard = [NSNumber numberWithInt:[self.attachedScorecard intValue]];
        ((GrintBReviewStats*)self.detailViewController).isNine = self.isNine;
